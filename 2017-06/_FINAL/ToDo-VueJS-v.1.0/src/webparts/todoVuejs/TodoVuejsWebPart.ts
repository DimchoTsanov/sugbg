...
import * as strings from 'todoVuejsStrings';

import TodoComponent from '../../components-vue/todo/Todo.vue';
import { ITodoProps2 } from '../../components-vue/todo/ITodoProps';
import { ITodoVuejsWebPartProps } from './ITodoVuejsWebPartProps';
...
export default class TodoVuejsWebPart extends BaseClientSideWebPart<ITodoVuejsWebPartProps> {

  public data: ITodoProps2;

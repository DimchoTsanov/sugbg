...
import * as strings from 'todoReactStrings';

import TodoReact from './components/TodoReact';
import ITodoReactProps from './components/ITodoReactProps';
import { ITodoReactWebPartProps } from './ITodoReactWebPartProps';
...
export default class TodoReactWebPart extends BaseClientSideWebPart<ITodoReactWebPartProps> {

  private _dropdownOptions: IPropertyPaneDropdownOption[];
  private _dataProvider: ITodoDataProvider;
  private _selectedList: ITodoTaskList;
  private _todoContainerComponent: TodoReact;
  ...
  public render(): void {
    ...
    */
    const element: React.ReactElement<ITodoReactProps> = React.createElement(
      TodoReact,
      {
    ...
    this._todoContainerComponent = <TodoReact>ReactDom.render(element, this.domElement);
  }
